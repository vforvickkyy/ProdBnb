...
// Public marketplace feed: always published-only, always an anonymous client
// — a host's own drafts never leak into this just because they happen to be
// signed in while browsing.
locationsRouter.get("/locations", validate({ query: listLocationsQuerySchema }), getPublicLocations);
